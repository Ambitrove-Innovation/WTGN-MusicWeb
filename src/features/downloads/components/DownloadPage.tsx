      ...
      {isOpen && item && (
        ...
        >
          ...
          <div className="absolute top-0 left-0 w-full p-6 flex justify-between items-center z-50">
            <div className="font-space font-bold tracking-widest uppercase text-white">W.T.G.N / Vault</div>
            <button 
          ...
          <div className="w-full max-w-6xl mx-auto p-4 md:p-12 min-h-screen py-24 flex flex-col justify-center">
            <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-center">
              ...
              >
                ...
                <img src={item.img || '/images/WTGN-cover-album-1.jpeg'} alt={item.title} className="w-full h-full object-cover shadow-[0_0_50px_rgba(255,255,255,0.05)] border border-white/10" />
              ...
              >
                ...
                <h1 className="font-clash text-4xl md:text-6xl font-bold text-white mb-2">{item.title}</h1>
                <p className="font-sans text-white/50 tracking-wider text-sm mb-12">
                  {item.type === 'bundle' ? 'Full Digital Album (MP3/WAV)' : 'High-Quality Digital Track (MP3/WAV)'}
                </p>
                ...
                <div className="space-y-4 mb-12">
                   <div className="bg-white/5 border border-white/10 p-5 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                      <div>
                         <div className="font-sans font-bold text-white mb-1">Standard Quality (MP3)</div>
                         <div className="font-sans text-xs text-white/40 uppercase tracking-wider">320kbps • ~8MB</div>
                      </div>
                   ...
                   <div className="bg-[#0a0a0a] border border-white/10 p-5 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                      <div>
                         <div className="font-sans font-bold text-white mb-1">Studio Quality (WAV)</div>
                         <div className="font-sans text-xs text-white/40 uppercase tracking-wider">Lossless • ~45MB</div>
                      </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  >
                    {isPlaying ? (
                      <>
                        <span className="text-xl leading-none">■</span> Stop Playback
                      </>
                    ) : (
                      <>
                        <span className="text-xl leading-none">▶</span> Listen Full Version
                      </>
                    )}
                  </button>
                </div>
