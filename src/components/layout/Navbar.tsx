  ...
  return (
    <motion.nav
      ...
      className={`fixed top-0 left-0 right-0 z-[1000] px-6 md:px-12 h-[72px] flex items-center justify-between transition-colors duration-400 ${
        isScrolled ? 'bg-black/70 backdrop-blur-2xl' : 'bg-transparent border-b border-white/5'
      }`}
    >
      <div className="flex items-center gap-2">
        <span className="font-clash font-bold text-[1.1rem] tracking-[0.12em] text-white">W.T.G.N</span>
        <span className="opacity-40 text-[0.65rem] tracking-[0.2em] font-sans font-light hidden sm:inline">EST. 2020</span>
      </div>
